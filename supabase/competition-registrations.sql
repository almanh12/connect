-- Run this in Supabase SQL Editor to create competition_registrations table
...
DROP POLICY IF EXISTS "Users can view their chapter registrations" ON competition_registrations;
...
DROP POLICY IF EXISTS "Admins can manage registrations" ON competition_registrations;
...
DROP POLICY IF EXISTS "Users can manage own registrations" ON competition_registrations;
